...
namespace Alza.Tests.Unit.ControllersTests
{
    public class ProductApiUnitTests : IClassFixture<BaseUnitTest>
    {
        private readonly BaseUnitTest baseUnitTest;

        public ProductApiUnitTests(BaseUnitTest baseUnitTest) : base()
        {
            this.baseUnitTest = baseUnitTest;
        }
